        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/dashboard') }}">
                    @if(Auth::check())  {{auth()->user()->name}} @else Dashboard @endif
                </a>
                @if(Auth::check())
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{url(route('post.index'))}}">show</a>
                            <a class="dropdown-item" href="{{url(route('post.create'))}}">Create</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{url(route('post.trashed'))}}">Soft deleted</a>
                        </div>
                    </li>
                </ul>
                @endif
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if(auth()->user()->hasRole('super_admin'))
                                    <a href="{{url(route('user.edit',Auth::user()->id))}}" class="dropdown-item">Profile</a>
                                    @endif
